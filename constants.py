...
BUTTON_BOTTOM_RIGHT2 = (SERVER_VIEW_WIDTH - BUTTON_SIZE[0] - BUTTON_MARGIN[0],
                       SERVER_VIEW_HEIGHT - 2*BUTTON_SIZE[1] - 2*BUTTON_MARGIN[1])
BUTTON_BOTTOM_RIGHT3 = (SERVER_VIEW_WIDTH - BUTTON_SIZE[0] - BUTTON_MARGIN[0],
                       SERVER_VIEW_HEIGHT - 3*BUTTON_SIZE[1] - 3*BUTTON_MARGIN[1])

BUTTON_BOTTOM_LEFT = (BUTTON_MARGIN[0], SERVER_VIEW_HEIGHT - BUTTON_SIZE[1] - BUTTON_MARGIN[1])

def BUTTON_TOP_LEFT(i):
    b = (BUTTON_MARGIN[0], BUTTON_MARGIN[1]+ i*BUTTON_MARGIN[1]+ i*BUTTON_MARGIN[1])
    return b

BUTTON_STYLE = {'fill': '#090', 'outline': '#090'}
BUTTON_STYLE_PRESSED = {'fill': '#02f502', 'outline': '#090'}
BUTTON_TEXT_STYLE = {'fill': '#fff'}

BUTTON_SIZE_UNIT = (14,2)
